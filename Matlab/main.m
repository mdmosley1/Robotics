...
servo1 = Servo(40.3-10,42.2,19.9);servo1.translate(-14.9,17.8,tk*2+sep+9.3);servo1.build('y');

splate2 = Servo(1.7,61,34.8); splate2.translate(49+12.1+1.7,11.5,tk*2+sep);splate2.build('g');

servo2 = Servo(40.3-8,42.2,19.9); servo2.translate(30.7,17.8,tk*2+sep+9.3);servo2.build('g');
